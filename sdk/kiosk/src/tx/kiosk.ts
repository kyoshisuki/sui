...
export function take(
	...
	const [item] = tx.moveCall({
		...
		typeArguments: [itemType],
		arguments: [tx.object(kiosk), tx.object(kioskCap), tx.pure.address(itemId)],
	});
...
export function list(
	...
	tx.moveCall({
		...
		typeArguments: [itemType],
		arguments: [tx.object(kiosk), tx.object(kioskCap), tx.pure.address(itemId), tx.pure.u64(price)],
	});
}
...
export function purchase(
	...
	const [item, transferRequest] = tx.moveCall({
		...
		typeArguments: [itemType],
		arguments: [tx.object(kiosk), tx.pure.address(itemId), tx.object(payment)],
	});
